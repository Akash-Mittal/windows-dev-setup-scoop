# PowerShell script to open Google Chrome with the "Personal" profile for "Nica" related tasks and specific tabs.

$CHROME = "chrome.exe"
$PROFILE = "Personal"

# Open default tabs for Personal profile (Nica)
Write-Host "Opening Chrome with profile '$PROFILE' for Nica tasks and specified tabs..."
...
Write-Host "Chrome startup script for Personal (Nica) profile completed."
