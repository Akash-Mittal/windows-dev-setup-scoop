...
## VPN Login (`start-vpn-login.ahk`)

The `start-vpn-login.ahk` script automates the process of logging into the Cisco Secure Client VPN.
...
2.  Run the `start-vpn-login.ahk` script by double-clicking the file.
